			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h4 class="text-left" style="position:relative; left:160px; top:-10px;">FAVOURITES</h4>&nbsp;&nbsp;&nbsp;<a href="favourites2a.php" class="focus">List</a>&nbsp;I&nbsp;<a href="favourites2b.php">Grid</a></p><hr>
...
echo "<br>";
echo "<form method='POST' id='idForm' action='favourites_add_ss.php' enctype='multipart/form-data'>
                      <div class='content' id='wrapper'>
                      <input class='btn btn-default' type='button' id='create' onclick='add_fields();' value='Create List' />
                       </div>
 </form> "; 	
}    
else	
...
<div class=alert alert-warning>
<span class=glyphicon glyphicon-info-sign></span> &nbsp; You have no Favourites yet.
Start adding Favourites to this list by clicking the icon next to the product and it will show up in this page.<a href='favourite_index.php'>Click here</a>
</div>
</div>	
 <form method='POST' id='idForm' action='favourites_add_ss.php' enctype='multipart/form-data'>
                      <div class='content' id='wrapper'>
                      <input class='btn btn-default' type='button' id='create' onclick='add_fields();' value='Create List' />
