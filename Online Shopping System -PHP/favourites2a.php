...
<p><b>FAVOURITES</b>&nbsp;&nbsp;&nbsp;<a href="favourites2a.php" class="focus">List</a>&nbsp;I&nbsp;<a href="favourites2b.php">Grid</a></p><hr>                       
...
<table class="table table-condensed">
					<thead>
						<tr class="cart_menu">						    
                            ...
                            <td style="position:relative;left:-70px" class="description">Name</td>
							<td style="position:relative;left:-130px" class="quantity">Price</td>							
                            <td style="position:relative;left:-200px">Options</td>
                            <td></td>                         
						</tr>
					</thead>
					...
					<tbody>
						...
						{
						?>
						<form method="POST" action="favourites_add_list_ss.php" enctype="multipart/form-data" >
						<tr>
						
						    
						
							<td class="cart_product">						     					   
							     <img name="vege_pic" style="position:relative;left:-40px" src="images/<?php echo $row['product_img']; ?>" alt="" />
 							</td>
							<input type='text' hidden="" name='productid' value=<?php echo $row['product_id']; ?>/>
							<td class="cart_description"> <!--cart_description-->
 <h4><p><input type='text' name='product_name' style="border:none"  value=<?php echo $row['product_name']; ?> readonly/></p></h4>	
 							</td>
						
							<td class="cart_total">
<p class="cart_total_price"><input type='text' name="product_price" size="5" value=<?php echo $row['product_pricekg']; ?> style="position:relative;left:-90px; border:none" /></p>
                               
							</td>
							
							
							<td class="">
<input style="position:relative; left:-200px" type="submit" id="button1" class="btn btn-success" name="Save"  value="Add to cart"/>	
							&nbsp;&nbsp;																				
							<!--<td class="cart_delete">-->
<button style="position:relative; left:-210px" type="submit" id="button2" class="btn btn-danger" name="Delete"><i class="fa fa-times"></i></button>
        ...
        <div class="col-xs-12">
        	<div class="alert alert-warning">
            	<span class="glyphicon glyphicon-info-sign"></span>No Data Found <br>
                
<div style="position:relative; right:100px;">Start adding Favourites to this list by clicking the icon next to the product and it will show up in this page.<a href='favourite_index.php'>Click here</a></div>
