...
<form action="cart.php" method="POST" onSubmit="return validate();">
 <h2  style="position:relative; left:400px;color:#FFF">Business</h2>
<input style="position:relative; left:320px; width:250px; " type="email" placeholder="Email Address" name="email" id="email" required>
<input style=" position:relative; width:250px; left:320px;" type="password" placeholder="Password" name="password" id="password" required>
<input style=" position:relative; width:250px; left:320px;" type="password" placeholder="Confirm Password" name="passwordc" id="passwordc" required> 
<input style=" position:relative; width:250px; left:650px; top:-150px" type="text" placeholder="Business Name" name="business" required>

 <select style=" position:relative; width:250px; left:650px; top:-145px" id="select" name="select" required>
 ...
 <input style=" position:relative; width:250px; left:650px; top:-127px" type="number" placeholder="mobile number" name="number" id="number"  required>
 
<button type="submit" name="register2" style="background-color: #0C3; color:white; outline-color:#FFF; position:relative; left:800px; top:-60px">Register</button>                                                           
</form>
                                        </div><!--/login form-->
                                    </div>
                                     <div class="col-sm-4 col-sm-offset-1" style="margin-top:50px">
                                         <div class="pull-right">
                                            ...
                                            <a style="position:relative; left:170px ;top:-54px" href="home-register-indv.php">Individual Acct</a>
                                            <br><br>
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<div id="displaythis" class="col-sm-4">
							...
							<h2><?php echo $row['product_name']; ?>(<?php echo $row['product_weightkg'];?>kg)</h2> 
